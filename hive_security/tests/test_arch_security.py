"""Tests for hive-security: 确定性规则引擎 arch_security（批次 1 回归，独立包移植版）。
...
from hive_security.arch_security import (
    SecurityFinding,
    SecurityReport,
...
from hive_security.threat_model import Threat, ThreatCatalog, ThreatCategory, ValidationPolicy
...
# ---------------------------------------------------------------------------
# 2. 循环依赖（复用包内 _validate_dependency_graph 语义）
# ---------------------------------------------------------------------------
